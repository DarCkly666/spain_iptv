...
class RadioAdapterGrid(private val mContext: Activity, private val channels: ArrayList<Channel>): RecyclerView.Adapter<RadioAdapterGrid.MyViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RadioAdapterGrid.MyViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.item_channel_grid, parent, false)
        return MyViewHolder(view)
    }

    override fun onBindViewHolder(holder: RadioAdapterGrid.MyViewHolder, position: Int) {
