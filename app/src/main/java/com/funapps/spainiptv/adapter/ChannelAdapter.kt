...
class ChannelAdapter(private val mContext: Activity, private val channels: ArrayList<Channel>): RecyclerView.Adapter<ChannelAdapter.MyViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ChannelAdapter.MyViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.item_channel, parent, false)
        return MyViewHolder(view)
    }

    override fun onBindViewHolder(holder: ChannelAdapter.MyViewHolder, position: Int) {
